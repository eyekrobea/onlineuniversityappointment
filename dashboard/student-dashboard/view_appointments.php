<?php
// Define the page title and student name as variables
$pageTitle = "View Appointments";
$studentName = "Student Name"; // This should be dynamically set, for example, from a session or database
?>
...
<head>
    ...
    <title>ProBookSys - <?php echo htmlspecialchars($pageTitle); ?></title>
...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="profile_management.php"><i class="fas fa-user"></i> <?php echo htmlspecialchars($studentName); ?></a>
                        </li>
                        <li class="nav-item">
    ...
    <script>
        ...
        function updateChartColors() {
            ...
            // You can implement this based on your chart.js configuration
        }
    </script>
</body>
</html>
