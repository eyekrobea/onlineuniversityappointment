...
<body>
    ...
    <div id="content">
        ...
        <div class="container">
            ...
            <a href="add-faculty.php" class="btn btn-primary mb-3">Add Faculty</a>
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    $faculty = [
                        ...
                        ['id' => 3, 'name' => 'Bob Johnson', 'department' => 'Physics'],
                    ];
                    ...
                    foreach ($faculty as $member) {
                        ...
                        echo "<td>
                                <a href='edit-faculty.php?id={$member['id']}' class='btn btn-sm btn-primary'>Edit</a>
                                <a href='delete-faculty.php?id={$member['id']}' class='btn btn-sm btn-danger' onclick='return confirm(\"Are you sure you want to delete this faculty member?\")'>Delete</a>
                              </td>";
                        echo "</tr>";
                    }
                    ?>
    ...
    <script>
        ...
        // Add any faculty-specific JavaScript here
        // Toggle sidebar
